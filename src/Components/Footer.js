    ...
    return (
        <div className='rounded-div mt-8 pt-8 text-primary'>
            <div className='grid md:grid-cols-2'>
                <div className='flex justify-evenly w-full uppercase md:max-w-[300px] uppercase'>
                    <div>
                ...
                <div className='text-right'>
                    <div className='w-full flex justify-end'>
                        ...
                        <div className='py-4'>
                            <form>
                                <input type="email" className='bg-primary border border-input p-2 mr-2 w-full shadow-xl rounded-2xl md:w-auto' placeholder='enter your email' />
                                <button className='bg-button text-btnText px-4
                                 p-2 w-full rounded-2xl shadow-xl hover:shadow-2xl 
                                 md:w-auto my-2'>sign up</button>
                            </form>
                        </div>
